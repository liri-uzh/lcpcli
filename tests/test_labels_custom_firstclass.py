...
def test_labels_custom_firstclass_corpus_creation():
    """Test creating a corpus with labels and custom first-class entities."""
    ...
    s2.make()
    d = c.Book(s1, s2, title="first document")
    d.make()
    c.make(TMP_FOLDER)
